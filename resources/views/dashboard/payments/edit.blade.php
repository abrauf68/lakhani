        ...
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.payments.update', $payment->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row p-5">
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <select name="customer_plot_file_id" class="form-select select2 @error('customer_plot_file_id') is-invalid @enderror"
                                ...
                                @foreach ($customerPlotFiles as $file)
                                    <option value="{{ $file->id }}" data-remaining="{{ $file->remaining_amount }}" {{ $payment->customer_plot_file_id == $file->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input type="number" step="0.01" name="amount" id="amount"
                                class="form-control @error('amount') is-invalid @enderror" value="{{ $payment->amount }}" required>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('ref_no') is-invalid @enderror" type="text" id="ref_no"
                                ...
                                value="{{ old('ref_no', $payment->ref_no) }}" />
                            @error('ref_no')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-4">
                                    ...
                                    <input class="form-control @error('bank_branch') is-invalid @enderror" type="text" id="bank_branch"
                                        ...
                                        value="{{ old('bank_branch', $payment->bank_branch) }}" />
                                    @error('bank_branch')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('remarks') is-invalid @enderror" id="remarks"
                                name="remarks" rows="3" placeholder="{{ __('Enter remarks (optional)') }}">{{ old('remarks', $payment->remarks) }}</textarea>
                            @error('remarks')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Edit Payment') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            $('#customer_plot_file_id').trigger('change');
